...
class Student:
    ...
    # Initialize the Student object with name and number
    ...
    # Calculate and return the GPA as a string
    def displayGPA(self):
        if len(self.courses) == 0:  # Handle case with no courses
    ...
    # Return a list of passed courses (grades > 0.0)
    def displayCourses(self):
        passed_courses = [course for course, grade in self.courses.items() if grade > 0.0]
        return passed_courses

if __name__ == '__main__':
    # Create and add grades for first student
    student1 = Student('John', '013454900')
    student1.addGrade('uli101', 1.0)
    student1.addGrade('ops245', 2.0)
    student1.addGrade('ops445', 3.0)

    # Create and add grades for second student
